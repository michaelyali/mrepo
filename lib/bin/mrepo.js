...
const scripts_generator_command_1 = require("../scripts-generator/scripts-generator.command");
...
if (configFile) {
    ...
    scripts_generator_command_1.ScriptsGeneratorCommand.load(program, configFile);
