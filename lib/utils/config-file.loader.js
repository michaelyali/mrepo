...
exports.validateConfigFile = exports.loadConfigFile = void 0;
...
function loadConfigFile() {
    const configFilePath = path_1.join(process.cwd(), `./${constants_1.CONFIG_FILE_NAME}`);
    const configFile = util_1.safeRequire(configFilePath);
    return configFile;
}
