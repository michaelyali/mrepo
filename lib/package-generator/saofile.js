    ...
    completed() {
        ...
        if (parentOptions.dryRun) {
            ...
            if (this.answers.updateTsconfig) {
                ...
                child_process_1.execSync(`npx json -I -f ${cwd}/tsconfig.json -e "this.compilerOptions['paths']['@${this.answers.packageScope}/${this.answers.packageName}']=['${this.answers.packageName}/src']"`);
                child_process_1.execSync(`npx json -I -f ${cwd}/tsconfig.json -e "this.compilerOptions['paths']['@${this.answers.packageScope}/${this.answers.packageName}/*']=['${this.answers.packageName}/src/*']"`);
