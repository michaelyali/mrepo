...
const LERNA_PACKAGES_VERSIONING_CHOICES = [
    {
        name: constants_1.LERNA_PACKAGES_VERSIONING.common,
        checked: true,
    },
    {
        name: constants_1.LERNA_PACKAGES_VERSIONING.independent,
    },
];
...
const defaultAnswers = {
    ...
    lernaPackagesVersioning: constants_1.LERNA_PACKAGES_VERSIONING.common,
...
const result = {
    ...
    actions() {
        ...
        this.answers.lernaPackagesVersioning =
            this.answers.lernaPackagesVersioning === constants_1.LERNA_PACKAGES_VERSIONING.independent
                ? constants_1.LERNA_PACKAGES_VERSIONING.independent
                : '0.0.0';
        if (parentOptions.dryRun) {
            return [];
        }
        ...
        return [
            ...
            },
            {
                ...
                patterns: {
                    ...
                    'githubWorkflowsRelease.yml': '.github/workflows/release.yml',
                    'githubPrTemplate.md': '.github/PULL_REQUEST_TEMPLATE.md',
                    'githubIssueTemplateBugReport.md': '.github/ISSUE_TEMPLATE/Bug_report.md',
                    'githubIssueTemplateFeatureRequest.md': '.github/ISSUE_TEMPLATE/Feature_request.md',
                    'githubIssueTemplateRegression.md': '.github/ISSUE_TEMPLATE/Regression.md',
                },
            },
        ];
    },
            ...
            if (!parentOptions.skipScripts) {
                ...
                if (!parentOptions.skipGit) {
                    ...
                    if (!parentOptions.skipGitCommit) {
                        child_process_1.execSync(`cd ${monorepoPath} && git add . && git commit -m "chore: initial commit" --no-verify && git tag v0.0.0`);
                    }
                }
            }
